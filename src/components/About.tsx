  ...
  return (
    ...
    <div className=" mx-auto relative border-l-4 border-blue-500 pl-6 space-y-12">
        ...
        <div key={index} className="relative pl-6">
            ...
            <p className="text-sm text-600 dark:text-gray-400">{item.course}</p>
            <p className="text-sm text-600 dark:text-gray-400">{item.duration}</p>
            <p className="text-sm text-600 dark:text-gray-400">CPI: {item.grade}</p>
